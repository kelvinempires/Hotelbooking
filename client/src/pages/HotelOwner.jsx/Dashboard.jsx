            ...
            {dashboardData.bookings.map((item, index) => (
              <tr key={index}>
                ...
                <td className="py-3 px-4 border-t border-gray-300">
                  <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? "bg-gray-200 text-gray-600" : "bg-amber-200 text-yellow-600"}`}>{item.isPaid ? "Completed" : "pending"}</button>
                </td>
              </tr>
            ))}
          </tbody>
