    ...
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30">
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        <Title
          ...
          subTitle="Take advantage of our limited-time exclusive deals! Don't miss your chance to unlock unbeatable discounts and premium offers—available only for a short period!"
        />
